...
class PageController extends Controller
{
    ...
    public function otherPages($para){
        $data =  array(
            ...
            'contact-us'=>'<p>We are only a phone call away and will be glad to assist you with any enquiries you may have. Call us on +998 71150 36 63 or email gm@tag-travels.com Alternatively fill up the form below and one of our associates will get back to you.</p>',
