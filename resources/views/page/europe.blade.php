        ...
        <div class="row">
            ...
            <div class="lqd-column col-md-8 col-md-offset-2 px-md-5">
                ...
                <header class="lqd-fancy-title text-center mb-30">
                    ...
                    <p class="text-dark" style="line-height:1">Europe seduces travellers with its spectacular natural scenery, magnificent mountains, beautiful coastal regions, iconic historic splendours, breath-taking imperial palaces and diverse artistic and culinary experiences. Chortoq travels will take you on once-in-a-lifetime journeys.</p>
                </header><!-- /.lqd-fancy-title -->

            </div><!-- /.lqd-column col-md-8 col-md-offset-2 -->
            @foreach ($europe as $key)
                ...
                <div class="lqd-column col-md-4 ">
                    ...
                    data-slideelement-options='{ "visibleElement": ".fancy-box-header", "hiddenElement": ".fancy-box-info" }'>
                        ...
                        <figure class="fancy-box-image" data-responsive-bg="true">
                            <img width="1550" height="1000" src="/assets/img/des/{{ Request::path() }}/{{ $key }}.jpg" alt="Italy & Sicily" />
                        </figure>
